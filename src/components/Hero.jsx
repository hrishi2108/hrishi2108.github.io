  ...
  return (
    <section id="home" className="hero container">
      <div data-reveal="fade-right">
        <h1>
          Hi, I'm <span className="accent" style={{color:'var(--primary-color)'}}>Hrishi Vikas Yadav</span>
        </h1>
        ...
        <div style={{marginTop: '16px'}}>
          ...
          <a className="btn" style={{marginLeft: '10px'}} href="/Hrishi-yadav-Resume.pdf" download>Download Resume</a>
        </div>
      </div>

      <div data-reveal="fade-left" style={{display:'flex', justifyContent:'center'}}>
        <img src="/profile.jpg" alt="Hrishi" />
      </div>
    </section>
  );
}
